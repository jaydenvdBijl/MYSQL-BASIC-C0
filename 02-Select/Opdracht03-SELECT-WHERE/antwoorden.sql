...
SELECT * FROM `jaar2016` WHERE rank = 7;
-- Opdracht 3
SELECT score FROM `jaar2015` WHERE rank = 7;
-- Opdracht 4
SELECT score FROM `jaar2016` WHERE rank = 7;
-- Opdracht 5
SELECT country FROM `jaar2015` WHERE region = "North America";
-- Opdracht 6 
SELECT country FROM `jaar2016` WHERE rank = 25;
-- Opdracht 7 
SELECT country FROM `jaar2016` WHERE score > 7078;
-- Opdracht 8
SELECT country FROM `jaar2016` WHERE rank <= 5;
-- Opdracht 9
SELECT score FROM `jaar2015` WHERE rank = 18;
-- Opdracht 10
